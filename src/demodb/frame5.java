 ...
 * frame5.java
 *
 * Created on Nov 23, 2013, 11:45:11 PM
 */
package demodb;
...
String k;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("1- U CANNOT MOVE TO THE PREVIOUS QUESTION");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 18));
        jLabel4.setText("2- SUBMISSION WILL TAKE PLACE IN THE LAST");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 18));
        jLabel5.setText("3- RULE OF NEGATIVE MARKING IS APPLIED");

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 18));
        jLabel6.setText("4- ON EACH CORRECT ANSWER U GET 1 MARK");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 18));
        jLabel7.setText("5- ON WRONG ANSWER .25 MARK WILL BE DEDUCTED");
        ...
        jButton1.setFont(new java.awt.Font("Times New Roman", 1, 48));
